  ...
  return (
    <section id="Propos" className="min-h-screen py-24 bg-gray-900 text-gray-100">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row gap-12">
        {/* Colonne Gauche : CV (Agrandie à 1/2) */}
        <div className="md:w-1/2">
          <div className="sticky top-24">
            <div className="relative group">
               <iframe
                src="/documents/Sandjy_CV.pdf#view=fitH&zoom=90"
                className="w-full h-[600px] border border-gray-700 rounded-xl shadow-2xl" 
        ...
        {/* Colonne Droite : Texte introductif (Ajustée à 1/2) */}
      ...
      {/* SECTION : QU'EST-CE QUE LE BUT INFORMATIQUE */}
