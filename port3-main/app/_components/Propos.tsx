    ...
    <div className="min-h-screen p-4 bg-gray-900 text-gray-100">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <h3 className="text-2xl font-bold text-white mb-6 border-b border-gray-700 pb-2">
          Qu&apos;est-ce que le BUT Informatique parcours REAL (réalisation d'applications : conception, développement, validation) ?
        </h3>
      ...
      <div className="max-w-4xl mx-auto mt-12 px-4">
        ...
        <div className="space-y-6">
          ...
          <div className="border-l-4 border-blue-500 pl-4">
            ...
            <p className="text-gray-300">BUT Informatique 2025-2026</p>
